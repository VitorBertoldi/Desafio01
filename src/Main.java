...
class Regulador {
    public void aplicar(Mercado[] mercados) {
        ...
        for (int i = 0; i < mercados.length; i++) { // para cada mercado ->
            ...
            System.out.println("O Mercado de " + mercado.getTipo() + " vendeu " + vendas + " reais") ;
            Arrays.sort(listaVendas);
            System.out.println("O Mercado de " + mercado.getTipo() + " vendeu " + listaVendas[2] + " reais, e foi o que mais vendeu") ;
